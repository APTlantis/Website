...
var testCases = []struct {
	...
	},
	{
		...
		output: &tkn.Policy{
			Inputs: []tkn.Wire{
				{Label: "spice", RawValue: "saffron", Value: tkn.HashStringToScalar(AttrHashKey, "saffron"), Positive: false},
				{Label: "region", RawValue: "persia", Value: tkn.HashStringToScalar(AttrHashKey, "persia"), Positive: false},
			},
			F: tkn.Formula{
				Gates: []tkn.Gate{
	...
	},
	{
		...
		output: &tkn.Policy{
			Inputs: []tkn.Wire{
				{Label: "spice", RawValue: "mace", Value: tkn.HashStringToScalar(AttrHashKey, "mace"), Positive: false},
				{Label: "spice", RawValue: "nutmeg", Value: tkn.HashStringToScalar(AttrHashKey, "nutmeg"), Positive: false},
			},
			F: tkn.Formula{
				Gates: []tkn.Gate{
	...
	},
	{
		...
		output: &tkn.Policy{
			Inputs: []tkn.Wire{
				{Label: "region", RawValue: "caribean", Value: tkn.HashStringToScalar(AttrHashKey, "caribean"), Positive: true},
				{Label: "fruit", RawValue: "stonefruit", Value: tkn.HashStringToScalar(AttrHashKey, "stonefruit"), Positive: false},
				{Label: "flower", RawValue: "hibiscus", Value: tkn.HashStringToScalar(AttrHashKey, "hibiscus"), Positive: true},
				{Label: "spice", RawValue: "mace", Value: tkn.HashStringToScalar(AttrHashKey, "mace"), Positive: false},
				{Label: "family", RawValue: "extracts", Value: tkn.HashStringToScalar(AttrHashKey, "extracts"), Positive: true},
				{Label: "family", RawValue: "chilis", Value: tkn.HashStringToScalar(AttrHashKey, "chilis"), Positive: true},
			},
			F: tkn.Formula{
				Gates: []tkn.Gate{
	...
	},
	{
		...
		output: &tkn.Policy{
			Inputs: []tkn.Wire{
				{Label: "9country8", RawValue: "france", Value: tkn.HashStringToScalar(AttrHashKey, "france"), Positive: true},
			},
			F: tkn.Formula{
				Gates: []tkn.Gate{},
			},
	...
	},
	{
		...
		output: &tkn.Policy{
			Inputs: []tkn.Wire{
				{Label: "country", RawValue: "afghanistan", Value: tkn.HashStringToScalar(AttrHashKey, "afghanistan"), Positive: true},
				{Label: "country", RawValue: "bactria", Value: tkn.HashStringToScalar(AttrHashKey, "bactria"), Positive: true},
				{Label: "king", RawValue: "alexander", Value: tkn.HashStringToScalar(AttrHashKey, "alexander"), Positive: false},
			},
			F: tkn.Formula{
				Gates: []tkn.Gate{
