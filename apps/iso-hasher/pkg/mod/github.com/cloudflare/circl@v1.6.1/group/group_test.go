...
func testAdd(t *testing.T, testTimes int, g Group) {
	Q := g.NewElement()
...
func testMul(t *testing.T, testTimes int, g Group) {
	Q := g.NewElement()
	kInv := g.NewScalar()
	for i := 0; i < testTimes; i++ {
		P := g.RandomElement(rand.Reader)
...
func testMulGen(t *testing.T, testTimes int, g Group) {
	G := g.Generator()
	P := g.NewElement()
	Q := g.NewElement()
	for i := 0; i < testTimes; i++ {
...
func testCMov(t *testing.T, testTimes int, g Group) {
	P := g.RandomElement(rand.Reader)
...
func testCSelect(t *testing.T, testTimes int, g Group) {
	P := g.RandomElement(rand.Reader)
	Q := g.RandomElement(rand.Reader)
