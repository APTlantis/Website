...
//
// mkpost is run after cgo -godefs; see README-iso_scanner_copier.md.
package main
...
func main() {
	...
	if goos == "linux" {
		if os.Getenv("GOLANG_SYS_BUILD") != "docker" {
			...
			os.Stderr.WriteString("See README-iso_scanner_copier.md\n")
			os.Exit(1)
		}
	}
...
// Code generated by the command above; see README-iso_scanner_copier.md. DO NOT EDIT.
