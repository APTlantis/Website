...
func TestSysvSharedMemory(t *testing.T) {
	// create ipc
	id, err := SysvShmGet(IPC_PRIVATE, 1024, IPC_CREAT|IPC_EXCL|0o600)
	...
	defer func() {
		_, err := SysvShmCtl(id, IPC_RMID, nil)
		if err != nil {
	...
	// detach
	if err = SysvShmDetach(b2); err != nil {
