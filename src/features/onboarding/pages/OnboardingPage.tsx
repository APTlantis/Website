      ...
      <div className="space-y-8">
        <section>
          <p className="text-gray-300 text-lg mb-6">
            Welcome to <strong>Aptlantis</strong> — a mythic, modular, mirror-driven infrastructure built for the preservation, 
            distribution, and celebration of open-source systems.
          </p>
          
          <p className="text-gray-300 mb-6">
            Aptlantis is <strong>not just a Linux mirror</strong> — it's a <strong>living archive</strong>, 
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-3 text-cyan-400">🚀 What Is Aptlantis?</h2>
          <p className="text-gray-300 mb-4">Aptlantis is:</p>
          <ul className="list-disc pl-6 space-y-2 text-gray-300">
            <li>🌀 A fully automated <strong>mirror hub</strong> (55+ distros, 70TB+ of data)</li>
            <li>🧩 A <strong>modular containerized system</strong> built with Go, Rust, Python, Kotlin, and TypeScript</li>
            <li>🧠 A system of <strong>real-time rsync syncers, dashboards, and metadata analysis</strong></li>
            <li>🖥️ A <strong>visually rich, dark-themed frontend</strong> with Bootstrap-powered cards and per-distro dashboards</li>
            <li>🧙 A project imbued with <strong>mythos</strong> (Akx Parsers, Relics, Conventicles, and Vanguard layers)</li>
          </ul>
        </section>

        <section>
          <h2 className="text-2xl font-semibold mb-3 text-cyan-400">📂 Directory & Network Structure</h2>
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-3 text-cyan-400">🔧 Getting Started (Dev)</h2>
...
cd aptlantis</code>
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-3 text-cyan-400">🌍 Live Services</h2>
          <div className="overflow-x-auto">
            <table className="min-w-full bg-gray-800 rounded-lg overflow-hidden">
              <thead className="bg-gray-700">
                <tr>
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-3 text-cyan-400">📜 Lore & Mythology</h2>
          <p className="text-gray-300 mb-4">
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-3 text-cyan-400">📸 Submissions & Screenshots</h2>
          <p className="text-gray-300 mb-4">
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-3 text-cyan-400">🤝 Contributing</h2>
          <p className="text-gray-300 mb-4">
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-3 text-cyan-400">📡 Contact</h2>
          <ul className="space-y-2 text-gray-300">
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-3 text-cyan-400">🧱 License</h2>
